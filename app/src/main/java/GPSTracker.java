...
/**
 * Created by Goldbin on 31.10.2016.
 */
...
//Диалоговое окно
    public void showSettingsAlert(){
        ...
        alertDialog.setTitle("Ах ТЫ МЕЛКИЙ! GPS отключено");
        alertDialog.setMessage("GPS отключен. Перейдите в настройки для активации!");
